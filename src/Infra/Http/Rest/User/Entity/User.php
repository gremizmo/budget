...
namespace App\Infra\Http\Rest\User\Entity;
...
#[ORM\Entity(repositoryClass: 'App\Infra\Http\Rest\User\Repository\UserCommandRepository')]
#[ORM\Table(name: 'user')]
class User extends UserModel implements UserInterface, SymfonyUserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: 'App\Infra\Http\Rest\Envelope\Entity\Envelope', mappedBy: 'user', cascade: ['persist', 'remove'])]
