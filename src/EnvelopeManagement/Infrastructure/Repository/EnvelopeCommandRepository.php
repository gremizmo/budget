...
class EnvelopeCommandRepository implements EnvelopeCommandRepositoryInterface
{
    ...
    INSERT INTO envelope_view (uuid, created_at, updated_at, current_budget, target_budget, title, user_uuid)
    VALUES (:uuid, :created_at, :updated_at, :current_budget, :target_budget, :title, :user_uuid)
